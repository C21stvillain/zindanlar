        ...
        <Card className="w-full max-w-sm rounded-lg overflow-hidden shadow-lg bg-card border border-border/20 card-hover transform transition-transform duration-300 hover:scale-105 relative">
            ...
            <div className="relative z-10 bg-black/60 w-full h-full flex flex-col justify-between">
                <CardHeader className="p-6">
                    <CardTitle className="text-2xl font-bold fantasy-accent mb-2 text-white drop-shadow">{monster.Name}</CardTitle>
                    <p className="text-muted-foreground mb-4 text-white drop-shadow">{monster.Title}</p>
                </CardHeader>
                <CardContent className="p-6 pt-0 flex justify-between items-center">
                    <p className="text-sm font-semibold text-white drop-shadow">
                        CR: <span className="text-primary">{monster.cr}</span>
                    </p>
